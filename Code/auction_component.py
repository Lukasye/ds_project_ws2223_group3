...
class auction_component:
    def __init__(self, TYPE, UDP_PORT):
        ...
        self.BROADCAST_IP = utils.get_broadcast_address() #utils.get_broadcast_address("100.117.226.110", "255.255.255.252") # utils.get_broadcast_address(self.MY_IP, "255.255.255.0")
